            ...
            <div class="m-4">
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <div class="m-3">
                        ...
                        <input type="text" name="trackingNum" class="form-control <?php echo (!empty($tracking_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $tracking; ?>" id="inputTracking" placeholder="tracking number">
